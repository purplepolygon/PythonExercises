...
def digital_root(number):
    ...
    while len(str(digital_root_number)) > 1:
        digital_root_number = sum(int(x) for x in str(digital_root_number) if x.isdigit())
    print("Original number: " + str(number) + " Digital root number: " + str(digital_root_number))
