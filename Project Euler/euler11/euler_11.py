#!/usr/bin/env python3
# Given the 20x20 grid, find the largest product of four numbers left, right, down, up, or diagonally.
# Return the largest product
# First sanitize the raw data by appending "[" "],," search and replace " " with ", ", remove all 00, remove trailing 0:
