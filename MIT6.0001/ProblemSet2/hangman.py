    ...
    while guesses > 0:
        ...
        if not guess.isalpha():
            ...
            print("Oops! That is not a valid character. \
                 You have " + str(warnings) + " left: " + get_guessed_word(secret_word, letters_guessed))
            continue
        elif guess not in get_available_letters(letters_guessed):
            warnings -= 1
            if warnings == 0:
                guesses -= 1
            print("Oops! You already guessed that character. You have\
                 " + str(warnings) + " left: " + get_guessed_word(secret_word, letters_guessed))
            continue
        ...
        if is_word_guessed(secret_word, letters_guessed):
            ...
            print("Your total score for this game is: " + str(guesses * secret_word_unique_chars))
            exit()
